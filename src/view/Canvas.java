...
public class Canvas<V extends Vertible<V>, E> extends VisualizationViewer<V, E>  implements Printable {
    ...
    */
   public Canvas(Vizualizador<V,E> gv, Layout<V, E> layout) {
      super(layout);
      this.gv = gv;
      initComponents();
   }
    ...
    */
   public Canvas(Vizualizador<V,E> gv, Layout<V, E> layout, Dimension preferredSize) {
    ...
    */
   public Canvas(Vizualizador<V,E> gv, VisualizationModel<V, E> model) {
      super(model);
      this.gv = gv;
      initComponents();
   }
    ...
    */
   public Canvas(Vizualizador<V,E> gv, VisualizationModel<V, E> model, Dimension preferredSize) {
