...
/**
 * This interface guarantees networks of activatable vertices, for instance a
 * {@link SocialNetwork social network} of activatable {@link Actor actors}.
 * Such networks are usable for simulations of activation processes such as the
 * spread of infections or of marketing trends in societies. This interface must
 * be implemented by networks that are to be visualized by the
 * {@link GraphViewer GraphViewer} class.
 * 
 * @author Andreas de Vries
 * @version 1.0
 * @param <V>
 *            the type of nodes of this network
 */
public interface NetworkOfActivatables<V extends Activatable> {
	...
	public HashSet<V> linearThresholdDiffusion(HashSet<V> seed);
